            ...
            <div key={step.key} className="flex flex-1 items-center last:flex-none">
              <div className="flex items-center gap-2">
                ...
                <div
                  className={`relative flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-xs font-bold transition-all duration-300 ${isDone
                    ...
                    : isActive
                      ? "bg-[#151933] text-white ring-3 ring-[#151933]/15"
              ...
              {i < ONBOARDING_STEPS.length - 1 && (
                <div className="mx-2 sm:mx-2.5 h-[2px] flex-1 overflow-hidden rounded-full bg-[#e2e8f0]">
                  <div
                    className="h-full rounded-full transition-all duration-500 ease-out bg-[#151933]"
                    style={{
      ...
      <div className="sm:hidden">
        <div className="mb-2 flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#151933] text-[10px] font-bold text-white">
              {currentIndex + 1}
            </span>
          ...
          <span className="rounded-full bg-[#f1f5f9] border border-[#e2e8f0] px-2.5 py-0.5 text-[11px] font-bold text-[#151933]">
            {progressPercent}% Complete
          </span>
        </div>
        <div className="h-1.5 w-full overflow-hidden rounded-full bg-[#e2e8f0]">
          <div
            className="h-full rounded-full transition-all duration-300 ease-out bg-[#151933]"
            style={{
