      ...
      <ModalBody className="p-5 space-y-4 text-left">
        ...
        <div className="space-y-1 text-left">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              readOnly
              value={seriesUrl}
              className="flex-1 rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] px-3.5 py-2 text-xs font-mono text-[#241618] select-all focus:border-[#3a2447] focus:bg-white focus:outline-none"
            />
            <button
              type="button"
              onClick={handleCopyLink}
              className="inline-flex items-center gap-1.5 rounded-xl bg-[#3a2447] hover:bg-[#2c1937] px-3.5 py-2 text-xs font-semibold text-white shadow-2xs transition-colors shrink-0 cursor-pointer"
            >
        ...
        <div className="space-y-2 rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] p-3.5 text-left">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 text-[#3a2447] font-bold text-xs">
              <Sparkles className="h-3.5 w-3.5" />
              <span>Ready-to-Paste Reel Caption</span>
            </div>
            <span className="text-[10px] bg-[#3a244714] text-[#3a2447] px-2 py-0.5 rounded-md font-bold">Recommended</span>
          </div>
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#3a2447] hover:bg-[#2c1937] px-4 py-2 text-xs font-semibold text-white shadow-2xs transition-colors cursor-pointer"
          >
