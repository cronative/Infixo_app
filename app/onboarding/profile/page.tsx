      ...
      <div className="mt-6 space-y-5">
        ...
        <div>
          ...
          {profile.username && usernameStatus?.available && (
            <p className="mt-1 text-xs text-[#54514D]">
              Your public handle: <span className="font-bold text-[#600a0f]">@{profile.username}</span>
            </p>
          )}
        </div>
        ...
        <div className="rounded-2xl border border-[#E7E3DC] bg-white p-4 space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-xs font-semibold uppercase tracking-wider text-[#54514D] flex items-center gap-1.5">
              <FileText className="h-3.5 w-3.5 text-[#600a0f]" />
              <span>Short Bio</span>
            </label>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-[#600a0f] hover:text-[#6F3456] bg-[#600a0f]/[0.09] hover:bg-[#600a0f]/15 px-2.5 py-1 rounded-full border border-[#600a0f]/20 transition-colors cursor-pointer"
            >
        ...
        <div className="pt-4 border-t border-[#E7E3DC] mt-8">
          <Button
            ...
            loading={submitting}
            onClick={handleNext}
            className="bg-[#600a0f] hover:bg-[#6F3456] text-white font-bold h-11 text-sm rounded-xl cursor-pointer shadow-xs"
          >
            Save &amp; Next →
          </Button>
        </div>
