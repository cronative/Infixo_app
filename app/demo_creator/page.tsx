      ...
      <main className="mx-auto max-w-xl">
        ...
        <div className="mt-8 rounded-3xl border border-gray-200 bg-white p-6 sm:p-8 text-center space-y-3.5 shadow-sm">
          ...
          <div className="pt-2">
            <Link
              href="/login"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#151933] hover:bg-[#6D3254] px-6 py-3.5 text-sm font-bold text-white shadow-md transition-all cursor-pointer w-full sm:w-auto"
            >
