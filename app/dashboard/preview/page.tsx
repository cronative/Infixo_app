    ...
    <div className="space-y-5 w-full pb-12 text-left">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-left">
        ...
        <div className="flex items-center gap-2.5 shrink-0 self-start sm:self-auto">
          ...
          >
            <Settings className="h-3.5 w-3.5 text-[#600a0f]" />
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-xl bg-[#600a0f] hover:bg-[#6F3456] px-3.5 py-2 text-xs font-semibold text-white transition-colors cursor-pointer shadow-xs"
          >
      ...
      <div className="flex items-center justify-between gap-3 rounded-2xl border border-[#E7E3DC] bg-white px-4 py-2.5 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#600a0f] bg-[#600a0f]/[0.09] border border-[#600a0f]/20 px-3 py-1.5 rounded-xl">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          >
            <RotateCw className={`h-3.5 w-3.5 ${isRefreshing ? "animate-spin text-[#600a0f]" : ""}`} />
            <span>Refresh</span>
          </button>
        </div>
      </div>
