...
export function CollaborationInquiryModal({
  ...
  return (
    <Modal
      ...
      icon={<Briefcase className="h-4 w-4 text-[#600a0f]" />}
    >
      {isSuccess ? (
        <div className="p-8 text-center space-y-3">
          ...
          <div className="pt-3">
            <button
              type="button"
              onClick={handleClose}
              className="bg-[#600a0f] hover:bg-[#600a0f] text-white text-xs font-semibold px-5 py-2.5 rounded-xl transition-colors cursor-pointer"
            >
              Done
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="text-left">
          <ModalBody className="p-5 sm:p-6 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] pl-8 pr-3 py-2 text-xs font-semibold text-[#241618] placeholder:text-[#6B5A5D]/60 focus:bg-white focus:border-[#600a0f] focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] px-3 py-2 text-xs font-semibold text-[#241618] placeholder:text-[#6B5A5D]/60 focus:bg-white focus:border-[#600a0f] focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] px-3 py-2 text-xs font-semibold text-[#241618] focus:bg-white focus:border-[#600a0f] focus:outline-none"
                >
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] p-3 text-xs font-semibold text-[#241618] placeholder:text-[#6B5A5D]/60 focus:bg-white focus:border-[#600a0f] focus:outline-none resize-none"
              />
            </div>
          </ModalBody>
          ...
          <ModalFooter className="p-4 sm:p-5 flex items-center justify-between">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center gap-1.5 rounded-xl bg-[#600a0f] hover:bg-[#600a0f] px-4 py-2 text-xs font-semibold text-white transition-colors cursor-pointer shadow-2xs disabled:opacity-50"
            >
              {submitting ? (
                <>
