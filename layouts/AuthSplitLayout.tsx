  ...
  return (
    <div className="flex min-h-dvh w-full bg-white">
      ...
      <div className="flex w-full flex-col justify-between px-6 py-8 sm:px-10 sm:py-10 lg:w-[48%] lg:px-14 lg:py-12 xl:w-[45%] bg-white border-r border-[#e2e8f0] min-h-dvh">
        ...
        <div className="text-center text-xs text-[#64748b] font-medium pt-4">
          &copy; 2026 Inflixo. All rights reserved.
        </div>
      </div>

      {/* Right / visual column */}
      <div className="relative hidden flex-1 overflow-hidden lg:block bg-[#043084]">
