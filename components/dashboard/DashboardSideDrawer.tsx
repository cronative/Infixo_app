  ...
  return (
    <div className="fixed inset-0 z-50 flex animate-in fade-in duration-200">
      ...
      <aside className="relative z-10 flex h-full w-[310px] sm:w-[340px] max-w-[85vw] flex-col overflow-hidden rounded-r-3xl bg-white shadow-2xl transition-transform duration-300 animate-in slide-in-from-left">
        ...
        {/* Creator Info Banner (Solid Logo Brand Purple #651FFF) */}
        <div className="mx-4 mt-4 rounded-2xl bg-[#651FFF] p-4 text-white shadow-md shadow-purple-600/25">
                ...
                >
                  ...
                  <ChevronRight
                    className={`h-4 w-4 transition-transform ${
                      active ? "text-[#651FFF] translate-x-0.5" : "text-slate-300"
                    }`}
                  />
                </Link>
              );
        ...
        <div className="border-t border-slate-100 p-4 bg-slate-50/50 space-y-2">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-purple-200 bg-purple-50/80 px-3.5 py-2.5 text-xs font-extrabold text-[#651FFF]">
            <div className="flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-[#651FFF] shrink-0" />
