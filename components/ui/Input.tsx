  ...
  ({ label, error, hint, leftIcon, rightSlot, prefix, className = "", id, ...rest }, ref) => {
    ...
    return (
      <div className="w-full text-left">
        ...
        <div
          className={`flex h-11 items-center rounded-[10px] border px-3.5 transition-colors focus-within:border-[#B85C6B] focus-within:ring-3 focus-within:ring-[#F3DDE0] ${rest.disabled ? "bg-[#F7F0EA] cursor-not-allowed text-[#6B5A5D] border-[#E4DAD5]" : "bg-[#FFFFFF]"
