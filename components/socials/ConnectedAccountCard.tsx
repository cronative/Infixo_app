  ...
  return (
    <div className="flex items-center justify-between gap-3 w-full">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <span className="font-display text-sm font-bold text-[#043084] truncate">
              {cleanHandle}
            </span>
          ...
          <p className="text-xs font-semibold text-[#64748b] mt-0.5">
            <span className="font-bold text-[#043084]">{formatCount(count)}</span> {countLabel}
          </p>
        </div>
      </div>
      ...
      <button
        ...
        disabled={loading}
        className="text-red-500 hover:text-[#043084] hover:bg-[#f1f5f9] text-xs font-medium px-3 py-1.5 rounded-lg transition-colors cursor-pointer self-start sm:self-auto shrink-0 disabled:opacity-50 inline-flex items-center gap-1"
      >
