      ...
      <div className="flex border-b border-[#E7E3DC] bg-[#fbfbfb] p-1 px-4 gap-1.5 shrink-0">
        <button
          ...
          className={`flex-1 rounded-lg py-1.5 text-xs font-semibold transition-colors cursor-pointer ${mode === "search"
            ? "bg-white text-[#3a2447] shadow-xs border border-[#E7E3DC]"
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#E7E3DC] bg-[#fbfbfb] py-2.5 pl-10 pr-4 text-xs font-semibold text-[#181716] placeholder:text-[#797570]/60 focus:border-[#3a2447] focus:bg-white focus:outline-none transition-colors"
              />
            </div>
              ...
              {filteredLocations.length > 0 ? (
                filteredLocations.map((loc, idx) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between rounded-xl p-2.5 text-left border border-[#E7E3DC] bg-white hover:border-[#3a2447]/30 hover:bg-[#FAF8F5] transition-colors group cursor-pointer"
                  >
                    <div className="flex items-center gap-2.5">
                      <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#fbfbfb] text-[#797570] group-hover:bg-[#3a2447]/[0.08] group-hover:text-[#3a2447] transition-colors shrink-0">
                        <Building className="h-3.5 w-3.5" />
                      </div>
                      <div>
                        <p className="text-xs font-bold text-[#181716] group-hover:text-[#3a2447] transition-colors">
                          {loc.city}
                        </p>
                    ...
                    <span className="text-xs font-semibold text-[#3a2447] opacity-0 group-hover:opacity-100 transition-opacity">
                      Select →
                    </span>
                  </button>
                ))
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#E7E3DC] bg-[#fbfbfb] py-2.5 pl-10 pr-3.5 text-xs font-semibold text-[#181716] placeholder:text-[#797570]/60 focus:border-[#3a2447] focus:bg-white focus:outline-none transition-colors"
                />
              </div>
            </div>
