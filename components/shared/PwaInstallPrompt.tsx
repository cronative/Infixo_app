...
export function PwaInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-md animate-fade-in-up">
      <div className="relative overflow-hidden rounded-3xl border border-[#E4DAD5] bg-white/95 p-4 sm:p-5 shadow-2xl shadow-[#600a0f]/15 backdrop-blur-xl">
        {/* Ambient Top Glow */}
        <div className="pointer-events-none absolute -top-10 left-1/2 h-20 w-40 -translate-x-1/2 rounded-full bg-[#600a0f]/10 blur-xl" />
        ...
        <div className="flex items-center gap-3.5 pr-6">
          {/* App Icon */}
          <div className="relative h-13 w-13 shrink-0 overflow-hidden rounded-2xl border border-[#E4DAD5] shadow-md bg-[#600a0f]">
            <Image
              src="/logo-square.png"
          ...
          <div className="min-w-0 flex-1 space-y-0.5 text-left">
            <div className="flex items-center gap-1.5">
              ...
              <span className="inline-flex items-center gap-0.5 rounded-full bg-[#F6EBF1] px-2 py-0.5 text-[9px] font-black text-[#600a0f] border border-[#E4DAD5]">
        ...
        <div className="mt-3.5 pt-3 border-t border-[#E4DAD5]/60">
          {isIOS ? (
            ...
            <div className="space-y-2 text-left">
              ...
              <div className="flex items-center gap-2 text-xs font-semibold text-slate-700">
                <span>2. Select</span>
                <span className="inline-flex items-center gap-1 rounded-md bg-[#F6EBF1] px-2 py-0.5 text-[11px] font-bold text-[#600a0f] border border-[#E4DAD5]">
            ...
            <button
              ...
              className="tap-scale w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-[#600a0f] hover:bg-[#6D3254] py-2.5 px-4 text-xs font-black text-white shadow-md shadow-[#600a0f]/20 transition-all hover:scale-[1.01] cursor-pointer"
            >
