          ...
          <ModalBody className="p-5 sm:p-6 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] pl-8 pr-3 py-2 text-xs font-semibold text-[#241618] placeholder:text-[#6B5A5D]/60 focus:bg-white focus:border-[#B85C6B] focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] px-3 py-2 text-xs font-semibold text-[#241618] placeholder:text-[#6B5A5D]/60 focus:bg-white focus:border-[#B85C6B] focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] px-3 py-2 text-xs font-semibold text-[#241618] focus:bg-white focus:border-[#B85C6B] focus:outline-none"
                >
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-[#E4DAD5] bg-[#fbfbfb] p-3 text-xs font-semibold text-[#241618] placeholder:text-[#6B5A5D]/60 focus:bg-white focus:border-[#B85C6B] focus:outline-none resize-none"
              />
            </div>
          </ModalBody>
