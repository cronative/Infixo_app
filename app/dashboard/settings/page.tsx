...
function SwitchToggle({
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-[#3a2447]/20 disabled:cursor-not-allowed disabled:opacity-50 ${
        checked ? "bg-[#3a2447]" : "bg-[#E7E3DC]"
      }`}
    >
      <span
