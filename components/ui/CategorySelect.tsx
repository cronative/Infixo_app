  ...
  return (
    <div className="w-full space-y-3">
      <div className="flex flex-wrap items-center justify-between gap-1.5">
        ...
        <span className="bg-[#b85c6b]/[0.09] text-[#b85c6b] border border-[#b85c6b]/20 text-xs font-semibold px-2.5 py-0.5 rounded-full shrink-0">
        ...
        {CREATOR_TAXONOMY.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isSelected && <Check className="h-3 w-3 stroke-[3] text-[#b85c6b] shrink-0" />}
            </button>
          );
        })}
      </div>
      ...
      {isOtherSelected && (
        <div className="animate-fade-in space-y-1.5 rounded-2xl border border-indigo-200 bg-indigo-50/60 p-3.5">
          ...
          <input
            ...
            className="w-full rounded-xl border border-indigo-200 bg-white px-3.5 py-2 text-xs font-bold text-slate-900 placeholder:text-slate-400 focus:border-[#b85c6b] focus:outline-none focus:ring-2 focus:ring-indigo-200"
          />
