...
CREATE TABLE episodes (
  ...
  external_url TEXT NOT NULL COMMENT 'Video link URL (YouTube/Instagram Reel/Facebook Video/Web Video)',
...
-- 14. MEDIA KIT COLLAB GIGS TABLE
-- ----------------------------------------------------------------------------
