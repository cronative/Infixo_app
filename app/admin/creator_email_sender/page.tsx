        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 rounded-xl bg-white border border-slate-200 px-3.5 py-1.5 text-xs font-bold text-slate-700 shadow-2xs">
              ...
              <span>Sender: <strong className="text-[#151933]">inflixoapp@gmail.com</strong></span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl bg-white border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-900 outline-none focus:border-[#151933] focus:ring-2 focus:ring-[#151933]/20 transition-all placeholder:text-slate-400 shadow-2xs"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full rounded-2xl bg-white border border-slate-200 p-4 text-xs sm:text-sm font-mono text-slate-800 outline-none focus:border-[#151933] focus:ring-2 focus:ring-[#151933]/20 transition-all leading-relaxed placeholder:text-slate-400 shadow-2xs"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="rounded-3xl border border-purple-100 bg-white p-6 space-y-4 shadow-xl shadow-purple-500/5">
              ...
              <textarea
                ...
                className="w-full rounded-xl bg-slate-50 border border-slate-200 p-3.5 text-xs font-mono text-slate-800 outline-none focus:border-[#151933] focus:ring-2 focus:ring-[#151933]/20 transition-all placeholder:text-slate-400"
            ...
            {dispatchLogs.length > 0 && (
              <div className="rounded-3xl border border-purple-100 bg-white p-6 space-y-4 shadow-xl shadow-purple-500/5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-extrabold text-[#151933]">
                ...
                <div className="space-y-1">
                  <div className="h-2.5 w-full rounded-full bg-slate-100 overflow-hidden border border-slate-200">
                    <div
                      className="h-full bg-gradient-to-r from-[#151933] to-rose-600 transition-all duration-300 rounded-full"
