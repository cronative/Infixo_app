      ...
      <div className="flex border-b border-[#E7E3DC] bg-[#F8F7F3] p-1 px-4 gap-1.5 shrink-0">
        <button
          ...
          className={`flex-1 rounded-lg py-1.5 text-xs font-semibold transition-colors cursor-pointer ${
            mode === "search"
              ? "bg-white text-[#803D63] shadow-xs border border-[#E7E3DC]"
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#E7E3DC] bg-[#F8F7F3] py-2.5 pl-10 pr-4 text-xs font-semibold text-[#181716] placeholder:text-[#797570]/60 focus:border-[#803D63] focus:bg-white focus:outline-none transition-colors"
              />
            </div>
              ...
              {filteredLocations.length > 0 ? (
                filteredLocations.map((loc, idx) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between rounded-xl p-2.5 text-left border border-[#E7E3DC] bg-white hover:border-[#803D63]/30 hover:bg-[#F8F7F3] transition-colors group cursor-pointer"
                  >
                    <div className="flex items-center gap-2.5">
                      <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#F8F7F3] text-[#797570] group-hover:bg-[#803D63]/[0.09] group-hover:text-[#803D63] transition-colors shrink-0">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#E7E3DC] bg-[#F8F7F3] py-2.5 pl-10 pr-3.5 text-xs font-semibold text-[#181716] placeholder:text-[#797570]/60 focus:border-[#803D63] focus:bg-white focus:outline-none transition-colors"
                />
              </div>
            </div>
