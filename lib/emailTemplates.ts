...
// Primary Brand Palette: #151933 (Inflixo Maroon)
...
function renderHeader(tagline: string = "Creator Platform • Collaboration & Growth"): string {
  return `
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #151933; border-radius: 16px 16px 0 0;">
      <tr>
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #F8FAFC; border-top: 1px solid #E2E8F0; border-radius: 0 0 16px 16px;">
      <tr>
        <td style="padding: 28px 32px; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
          ...
          <!-- Brand Tagline -->
          <p style="color: #151933; font-size: 13px; font-weight: 800; margin: 0 0 4px 0;">
            Inflixo
          </p>
          ...
          <!-- Navigation Links -->
          <p style="color: #151933; font-size: 12px; font-weight: 700; margin: 0 0 14px 0;">
            <a href="https://inflixo.com" target="_blank" style="color: #151933; text-decoration: none;">inflixo.com</a>
            &nbsp;•&nbsp;
            <a href="https://inflixo.com/privacy" target="_blank" style="color: #151933; text-decoration: none;">Privacy Policy</a>
            &nbsp;•&nbsp;
            <a href="https://inflixo.com/terms" target="_blank" style="color: #151933; text-decoration: none;">Terms of Service</a>
            &nbsp;•&nbsp;
            <a href="mailto:support@inflixo.com" style="color: #151933; text-decoration: none;">Help &amp; Support</a>
          </p>
...
function renderHeroBadge(badgeText: string): string {
  return `
    <div style="display: inline-block; background-color: #F8F1F5; border: 1px solid #E8DCE4; border-radius: 20px; padding: 4px 14px; margin-bottom: 16px;">
      <span style="color: #151933; font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
        ${badgeText}
      </span>
    </div>
  `;
...
function renderCtaButton(label: string, url: string, microCopy?: string): string {
  ...
  return `
    <div style="text-align: center; margin: 32px 0 24px 0;">
      <!--[if mso]>
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}" style="height:50px;v-text-anchor:middle;width:240px;" arcsize="24%" stroke="f" fillcolor="#151933">
        <w:anchorlock/>
        <center style="color:#ffffff;font-family:sans-serif;font-size:15px;font-weight:bold;">${label}</center>
      </v:roundrect>
      <![endif]-->
      <!--[if !mso]><!-->
      <a href="${url}" target="_blank" style="background-color: #151933; color: #FFFFFF; text-decoration: none; font-size: 15px; font-weight: 800; padding: 14px 32px; border-radius: 12px; display: inline-block; line-height: 1; box-shadow: 0 4px 14px rgba(128, 61, 99, 0.25); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
        ${label}
      </a>
      <!--<![endif]-->
      ${microTextHtml}
  ...
  const rowsHtml = items
    .map(
      ...
      <tr>
        ...
        <td style="padding: 12px 16px; border-bottom: 1px solid #F1F5F9; color: #151933; font-size: 13px; font-weight: 800; width: 65%; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
          ${item.isLink
          ? `<a href="${item.value}" target="_blank" style="color: #151933; text-decoration: underline;">View Content ↗</a>`
          : item.value
        }
        </td>
      </tr>
  ...
  switch (type) {
    ...
    case "otp": {
      ...
      const body = `
        ...
        <div style="background-color: #F8F1F5; border: 2px dashed #151933; border-radius: 16px; padding: 24px 16px; text-align: center; margin-bottom: 24px;">
          <div style="font-size: 44px; font-weight: 900; letter-spacing: 16px; color: #151933; font-family: 'Courier New', Courier, monospace; line-height: 1; padding-left: 16px;">
            ${code}
          </div>
        </div>
