    ...
    >
      ...
      <ModalFooter className="px-5 py-3.5">
        ...
        <button
          ...
          disabled={notified}
          className="bg-[#151933] hover:bg-[#2c1937] text-white font-semibold text-xs py-2 px-4 rounded-xl transition-colors cursor-pointer shadow-xs inline-flex items-center gap-1.5"
        >
