...
export default function LandingHomePage() {
    ...
    return (
      <div className="flex min-h-dvh items-center justify-center bg-[#F9FAFB]">
        <div className="flex flex-col items-center gap-3">
          <div className="h-8 w-8 animate-spin rounded-full border-2 border-[#600a0f] border-t-transparent" />
  ...
  return (
    <div className="min-h-dvh bg-[#FFFFFF] text-[#111827] flex flex-col font-sans selection:bg-purple-100 selection:text-[#600a0f]">
      {/* 1. NAVIGATION BAR */}
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={() => handleClaim("")}
              className="inline-flex items-center gap-1.5 rounded-full bg-[#600a0f] px-4 py-2 text-xs sm:text-sm font-bold text-white hover:bg-[#6D3254] transition-colors cursor-pointer"
            >
            ...
            <div className="lg:col-span-6 space-y-5 text-left pt-1">
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="inline-flex items-center gap-1.5 rounded-full border border-purple-200 bg-purple-50 px-3.5 py-1 text-xs font-bold text-[#600a0f] transition-all">
                  ...
                  <div className="flex items-center gap-1.5 bg-white border border-[#E5E7EB] rounded-full px-2 py-0.5 shadow-2xs">
                    <button
                      ...
                      className="p-1 rounded-full hover:bg-purple-50 hover:text-[#600a0f] text-slate-500 transition-colors cursor-pointer"
                  ...
                  >
                    {HERO_SLIDES.map((slide, idx) => (
                      ...
                      >
                        ...
                        <p className="text-base sm:text-lg font-bold text-[#600a0f] leading-relaxed">
                          {slide.subheading}
                        </p>
                      </div>
                    ))}
              ...
              <div className="space-y-3 pt-1">
                <form
                  ...
                  className="flex items-center rounded-xl border border-[#E5E7EB] bg-white p-1.5 focus-within:border-[#600a0f] focus-within:ring-2 focus-within:ring-[#600a0f]/20 transition-all max-w-md shadow-xs"
                >
                  <span className="pl-3.5 text-xs sm:text-sm font-bold text-[#600a0f] select-none shrink-0">
                    inflixo.com/
                  </span>
                  <input
                    type="text"
                  ...
                  <button
                    type="submit"
                    className="hidden inline-flex items-center gap-1.5 shrink-0 rounded-lg bg-[#600a0f] px-4 py-2 text-xs sm:text-sm font-bold text-white hover:bg-[#6D3254] transition-colors cursor-pointer shadow-2xs"
                  >
                ...
                <div className="pt-4 border-t border-[#E5E7EB] grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs font-bold text-[#111827]">
                  <div className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-[#600a0f] shrink-0 stroke-[3]" />
              ...
              <div className="border-t border-[#E5E7EB] pt-8 mt-8 sm:mt-12 lg:mt-16 space-y-4">
                <span className="inline-block rounded-full bg-purple-50 text-[#600a0f] border border-purple-200 px-3 py-0.5 text-xs font-bold uppercase tracking-wider">
                ...
                <div className="space-y-2 pt-1 text-xs sm:text-sm font-semibold text-[#111827]">
                  <div className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-[#600a0f] shrink-0 mt-0.5 stroke-[3]" />
                    <div>
            ...
            <div className="lg:col-span-6 flex flex-col items-center justify-start w-full">
              <div className="w-full max-w-[520px] rounded-2xl border border-slate-200 bg-white p-2.5 sm:p-3 relative transition-all duration-700 space-y-3">
                ...
                <button
                  ...
                  className="w-full tap-scale py-3 px-4 rounded-xl bg-[#600a0f] hover:bg-[#6D3254] text-white font-extrabold text-xs sm:text-sm transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="lg:col-span-6 flex justify-center order-2 lg:order-1">
              <div className="w-full max-w-md rounded-xl border border-[#E5E7EB] bg-[#111827] text-white p-5 space-y-4 text-left">
                <div className="flex items-center justify-between">
                  <span className="rounded bg-[#600a0f] px-2.5 py-0.5 text-[10px] font-bold text-white">
                    Season 1 • 5 Episodes
                  </span>
                ...
                <div className="relative h-40 w-full overflow-hidden rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <button
                      type="button"
                      className="flex h-10 w-10 items-center justify-center rounded-full bg-[#600a0f] text-white"
                    >
            ...
            <div className="lg:col-span-6 flex justify-center">
              <div className="w-full max-w-md rounded-2xl border-2 border-amber-400 bg-gradient-to-b from-amber-50/40 via-white to-white p-5 space-y-4 text-left shadow-lg relative">
                ...
                <div className="rounded-xl border border-amber-200 bg-white p-4 space-y-2.5 shadow-2xs relative">
                  <span className="absolute -top-2 right-3 bg-[#600a0f] text-white text-[9px] font-black px-2 py-0.5 rounded-full">
                    MOST POPULAR
                  </span>
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <span className="border text-[9px] font-extrabold px-2 py-0.5 rounded uppercase bg-[#F6EBF1] text-[#600a0f] border-[#E8DCE4]">
                        Instagram Reel
                      </span>
                      <h5 className="font-bold text-sm text-slate-900 mt-1">1x High-Engagement Dedicated Reel</h5>
                    </div>
                    <span className="font-extrabold text-base text-[#600a0f] tabular-nums">₹2,000</span>
                  </div>
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-4 space-y-2.5 shadow-2xs">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="font-extrabold text-base text-[#600a0f] tabular-nums">₹5,400</span>
                  </div>
          ...
          <div className="rounded-2xl border border-[#E5E7EB] bg-[#F9FAFB] p-8 sm:p-12 text-center space-y-6">
            ...
            <div className="max-w-md mx-auto space-y-3 pt-2">
              <form
                ...
                className="flex items-center rounded-xl border border-[#E5E7EB] bg-white p-1.5 focus-within:border-[#600a0f] focus-within:ring-2 focus-within:ring-[#600a0f]/20 transition-all shadow-xs"
              >
                <span className="pl-3.5 text-xs sm:text-sm font-bold text-[#600a0f] select-none shrink-0">
                  inflixo.com/
                </span>
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-1 shrink-0 rounded-lg bg-[#600a0f] px-4 py-2 text-xs sm:text-sm font-bold text-white hover:bg-[#6D3254] transition-colors cursor-pointer shadow-2xs"
                >
                  <span>Claim Handle</span>
                </button>
              </form>
