      ...
      <main className="mx-auto max-w-4xl px-5 sm:px-8 py-12 sm:py-16 flex-1 text-left space-y-10">
        ...
        <div className="space-y-8 text-sm sm:text-base leading-relaxed text-[#54514D] font-normal">
          ...
          <section className="space-y-3">
            ...
            <p>
              You maintain full ownership of your profile data. You have the right to inspect, edit, or request complete deletion of your Inflixo creator profile, series listings, and connected social tokens. To request complete account erasure, email us at <strong className="text-[#3a2447]">privacy@inflixo.com</strong>.
            </p>
          </section>
      ...
      <footer className="border-t border-[#E7E3DC] bg-white py-8">
        <div className="mx-auto max-w-[1200px] px-5 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold text-[#54514D]">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <Link href="/privacy" className="text-[#3a2447] font-bold">Privacy Policy</Link>
            <Link href="/cookies" className="hover:text-[#3a2447] transition-colors">Cookie Policy</Link>
            <CookiePreferencesButton className="hover:text-[#3a2447] transition-colors cursor-pointer font-semibold" />
