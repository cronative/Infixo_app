...
export default function DashboardProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-[#E7E3DC] bg-white p-5 sm:p-6 shadow-xs space-y-5">
        <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start pt-1">
          ...
          <div className="md:col-span-4 flex flex-col items-center sm:items-start gap-3">
            ...
            <div className="space-y-1.5 text-center sm:text-left">
              ...
              <p className="text-[11px] text-[#797570] leading-tight">
                Used across your public profile.
              </p>
              <p className="text-[10px] text-[#797570]/80">
          ...
          <div className="md:col-span-8 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              {errors.displayName ? (
                ...
                <p className="text-[11px] text-[#797570]">The name followers and brands will see.</p>
              )}
            </div>
      ...
      <section className="rounded-2xl border border-[#E7E3DC] bg-white p-5 sm:p-6 shadow-xs space-y-4">
        ...
        {errors.category && (
          <p className="text-xs font-semibold text-[#C2414B]">{errors.category}</p>
        )}

        {/* Selected Categories Display */}
        {selectedCategories.length > 0 && (
          <div className="space-y-1.5 pt-1">
            <p className="text-[11px] font-bold uppercase tracking-wider text-[#797570]">
              Selected Categories:
            </p>
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="hover:text-[#C2414B] transition-colors cursor-pointer ml-0.5"
                      title={`Remove ${cat}`}
                    >
        ...
        {selectedCategories.length >= 3 && (
          <p className="text-[11px] font-medium text-[#797570]">
      ...
      <section className="rounded-2xl border border-[#E7E3DC] bg-white p-4 sm:p-5 flex items-center justify-between gap-3 shadow-xs">
        <button
          type="button"
