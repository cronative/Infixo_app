  ...
  const TOGGLE_ITEMS: {
    ...
    color: string;
  }[] = [
      {
        ...
        icon: Users,
        color: "text-[#b85c6b] bg-[#b85c6b]/[0.09] border border-[#b85c6b]/20",
      },
      {
        key: "showInstagram",
      ...
      <ModalBody className="p-4 sm:p-5 space-y-3.5 divide-y divide-[#ECE8E1]">
        ...
        <div className="pb-3.5 flex items-center justify-between gap-3">
          <div className="flex items-start gap-3 min-w-0">
            <div className="p-2 rounded-xl shrink-0 text-[#b85c6b] bg-[#b85c6b]/[0.09] border border-[#b85c6b]/20">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${allEnabled ? "bg-[#b85c6b]" : "bg-[#E7E3DC]"
              }`}
          >
            <span
              className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-xs ring-0 transition duration-200 ease-in-out ${allEnabled ? "translate-x-5" : "translate-x-0"
                }`}
            />
          </button>
        </div>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${isEnabled ? "bg-[#b85c6b]" : "bg-[#E7E3DC]"
                  }`}
              >
                <span
                  className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-xs ring-0 transition duration-200 ease-in-out ${isEnabled ? "translate-x-5" : "translate-x-0"
                    }`}
                />
              </button>
            </div>
