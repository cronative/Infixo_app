    ...
    <div className={containerClass}>
      <div className="relative z-10 flex flex-col items-center max-w-lg w-full space-y-5">
        ...
        <div className="relative flex h-14 w-14 items-center justify-center">
          ...
          <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-[#803D63] text-white shadow-md">
        ...
        <div className="space-y-1 text-center">
          <div className="flex items-center justify-center gap-1.5">
            ...
            <span className="rounded-full bg-purple-50 border border-purple-200 px-2 py-0.5 text-[9px] font-bold text-[#803D63] uppercase tracking-wider">
              Syncing
            </span>
          </div>
        ...
        {!hideProgressBar && (
          <div className="w-48 space-y-1">
            <div className="h-1.5 w-full overflow-hidden rounded-full bg-slate-100 border border-slate-200">
              <div
                className="h-full bg-gradient-to-r from-[#803D63] to-purple-600 transition-all duration-300 ease-out"
        ...
        <div className="min-h-[48px] flex items-center justify-center px-4 w-full">
          <p
            className={`text-sm sm:text-base font-semibold italic text-[#803D63] leading-snug text-center transition-opacity duration-300 ${
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-2 text-xs animate-fadeIn">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1 font-semibold text-[#803D63] hover:underline"
              >
