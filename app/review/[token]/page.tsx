    ...
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center p-4 bg-[#FAF9F6] text-[#181716] text-center">
        <div className="max-w-sm">
          <EmptyState
            icon={<MessageSquare className="h-6 w-6 text-[#600a0f]" />}
            title="Review Link Invalid or Expired"
            description="This review request link doesn't exist or is invalid."
            action={
              <Link href="/" className="text-xs font-bold text-[#600a0f] hover:underline">
    ...
    <div className="space-y-1 py-2.5 px-3.5 bg-[#fbfbfb] rounded-xl border border-[#E7E3DC]">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-1.5 min-w-0">
          <Icon className="h-4 w-4 text-[#600a0f] shrink-0" />
    ...
    <div className="min-h-dvh bg-[#FAF9F6] text-[#181716] flex flex-col items-center justify-center p-4 sm:p-6 text-left relative">
      ...
      <main className="max-w-lg w-full space-y-5 my-6">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-[#E7E3DC]">
          <Logo size="sm" />
          <span className="inline-flex items-center gap-1 rounded-full bg-[#600a0f]/[0.09] border border-[#600a0f]/20 px-3 py-1 text-[10px] font-extrabold text-[#600a0f] uppercase tracking-wider">
        ...
        <div className="rounded-2xl border border-[#E7E3DC] bg-white p-4 sm:p-5 flex items-center gap-4 shadow-xs">
          <CreatorAvatar
            ...
            className="w-14 h-14 rounded-full border-2 border-[#600a0f]/30 object-cover shrink-0"
            textClassName="text-lg font-black text-[#600a0f]"
            fallbackBgClass="bg-[#600a0f]/[0.09]"
          />
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs font-bold text-[#600a0f]">
        ...
        <div className="rounded-2xl border border-[#E7E3DC] bg-[#fbfbfb] p-4 space-y-3 shadow-xs">
          <div className="flex items-center justify-between gap-2 border-b border-[#E7E3DC] pb-2.5">
            <div className="flex items-center gap-2 min-w-0">
              <Building2 className="h-4 w-4 text-[#600a0f] shrink-0" />
          ...
          <div className="flex items-center justify-between gap-2 pt-0.5">
            ...
            {reviewData.contentUrl && (
              <a
                ...
                className="bg-[#600a0f] hover:bg-[#6F3456] text-white font-extrabold text-xs px-3 py-1.5 rounded-xl transition-all inline-flex items-center gap-1 shrink-0 shadow-xs"
              >
          ...
          <div className="rounded-3xl border border-amber-200 bg-amber-50/80 p-6 text-center space-y-4 shadow-sm animate-in zoom-in-95">
            ...
            <div className="pt-3 border-t border-amber-200/80 text-xs">
              <Link
                ...
                className="bg-[#600a0f] hover:bg-[#6F3456] text-white font-extrabold px-4 py-2.5 rounded-xl transition-all inline-flex items-center gap-1.5 shadow-sm"
              >
            ...
            <form onSubmit={handleSubmitReview} className="space-y-3.5">
              ...
              <div className="space-y-2 pt-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 bg-[#600a0f]/[0.09] hover:bg-[#600a0f]/15 text-[#600a0f] text-[11px] font-extrabold px-2.5 py-1 rounded-lg border border-[#600a0f]/20 transition-all cursor-pointer shadow-2xs"
                  >
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-[#E7E3DC] bg-[#fbfbfb] px-3.5 py-2.5 text-xs font-medium text-[#181716] placeholder-[#797570] focus:border-[#600a0f] focus:bg-white focus:outline-none"
                />
                ...
                <div className="pt-0.5 space-y-1.5">
                  <div className="flex flex-wrap gap-1.5">
                    {aiSuggestions.map((suggestion, idx) => (
                      <button
                        ...
                        className="bg-[#fbfbfb] hover:bg-[#600a0f]/[0.09] hover:border-[#600a0f]/40 text-[#54514D] hover:text-[#600a0f] text-[10.5px] font-semibold px-2.5 py-1 rounded-xl border border-[#E7E3DC] transition-all text-left cursor-pointer"
                      >
                        {suggestion}
                      </button>
                    ))}
                  ...
                  <div className="pt-1 text-right">
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-[10.5px] font-bold text-[#600a0f] hover:underline cursor-pointer"
                    >
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#600a0f] hover:bg-[#6F3456] text-white font-extrabold text-sm py-3.5 px-4 rounded-xl transition-all shadow-xs cursor-pointer flex items-center justify-center gap-2"
                >
